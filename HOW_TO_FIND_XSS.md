...
4. Context: HTML body (inside )
5. Payload: alert('XSS')
6. Submitted → Alert popped
7. Determined: REFLECTED (URL echoed by server)
8. Confirmed: Unencoded, multiple payloads work
9. Documented: Full URL, payload, screenshot
